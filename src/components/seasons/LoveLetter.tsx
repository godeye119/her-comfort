...
export const LoveLetter: React.FC<LoveLetterProps> = ({ onClose }) => {
  return (
    ...
    >
      <motion.div
        initial={{ scaleY: 0, opacity: 0, rotateX: -30 }}
        animate={{ scaleY: 1, opacity: 1, rotateX: 0 }}
        exit={{ scaleY: 0, opacity: 0, rotateX: 30 }}
        transition={{
          type: "spring",
          damping: 20,
          stiffness: 100,
          ...
          <div className="relative z-10 p-8 md:p-12 lg:p-16 h-full flex flex-col justify-center">
            ...
            >
              <div className="flex flex-col gap-2">
                <p className="text-xs md:text-sm uppercase tracking-[0.3em] text-orange-900/70 font-light">
                  For You
                </p>
              ...
              <div className="flex flex-col gap-4 md:gap-6 text-orange-950">
                ...
                >
                  In this moment, I want you to know that you are loved. Your
                  presence in this world matters more than you realize.
                </p>
                <p
                  className="text-base md:text-lg lg:text-xl leading-relaxed"
                  style={{ fontFamily: "'Dancing Script', cursive" }}
                >
                  When the weight feels heavy, remember: you don't have to carry
                  it alone. I am here, holding space for you, believing in you.
                  I will always walk by your side holding your hand 💖
                </p>
                <p
                  className="text-base md:text-lg lg:text-xl leading-relaxed"
                  style={{ fontFamily: "'Dancing Script', cursive" }}
                >
                  Take all the time you need to rest. Care for yourself as
                  tenderly as you care for others, and keep that radiant smile
                  alive.☺️
                </p>
                <p
                  className="text-2xl md:text-3xl lg:text-4xl leading-relaxed mt-2 md:mt-4"
                  style={{ fontFamily: "'Great Vibes', cursive" }}
                >
                  Forever yours, Your constant companion ❤️
                </p>
                <div className="flex items-center justify-center gap-2 mt-2">
                  <div className="w-6 md:w-8 h-px bg-orange-600/50" />
                  <Heart
                    size={16}
                    className="text-orange-600/70 fill-orange-600/40"
                  />
                  <div className="w-6 md:w-8 h-px bg-orange-600/50" />
                </div>
              </div>
